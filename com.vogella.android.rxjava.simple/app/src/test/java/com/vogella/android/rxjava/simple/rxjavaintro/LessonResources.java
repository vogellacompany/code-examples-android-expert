...
public class LessonResources {
    ...
    public static class Elevator {
        ...
        public int getTotalWeightInPounds() {
            return Observable.fromIterable(mPassengers).reduce(0, (accumulatedWeight, elevatorPassenger) ->
                    elevatorPassenger.mWeightInPounds + accumulatedWeight).blockingGet();
        }
